...
image_reflection = {
    NULL: np.array(I.open("xdbot_resources/stone_bricks.png").convert('RGB')),
    WALL: np.array(I.open("xdbot_resources/bricks.png").convert('RGB')),
    START: np.array(I.open("xdbot_resources/iron_block.png").convert('RGB')),
    TERMINAL: np.array(I.open("xdbot_resources/diamond_block.png").convert('RGB')),
    PISTON: np.array(I.open("xdbot_resources/piston_top.png").convert('RGB')),
    SAND: np.array(I.open("xdbot_resources/sand.png").convert('RGB')),
    COBWEB: np.array(I.open("xdbot_resources/cobweb.png").convert('RGB'))
}
